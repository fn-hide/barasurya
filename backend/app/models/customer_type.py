...
class CustomerType(CustomerTypeBase, table=True):
    ...
    owner: "User" = Relationship(back_populates="customer_types") # type: ignore
    
    customers: list["Customer"] = Relationship(back_populates="customer_type", cascade_delete=True) # type: ignore
